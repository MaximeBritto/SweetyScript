...
local _currentPokedexPage = "Recettes"
...
local function createPokedexInterface()
    ...
    titre.Text = (isMobile or isSmallScreen) and "📚 RECETTES" or "📚 POKÉDEX DES RECETTES"
    ...
    local function _createChallengeCard(parent, rareteName, data)
        ...
        progress.Text = string.format("%d/%d bonbons complétés", data.done, data.total)
